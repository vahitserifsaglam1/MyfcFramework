...
return array(
    ...
    'Myfc\\Cache\\CacheManager' => $vendorDir . '/framework/Myfc/Cache/CacheManager.php',
    'Myfc\\Cache\\Connector\\Apc' => $vendorDir . '/framework/Myfc/Cache/Store/Apc.php',
    'Myfc\\Cache\\Connector\\Connectorapc' => $vendorDir . '/framework/Myfc/Cache/Connector/Connectorapc/Connectorapc.php',
    'Myfc\\Cache\\Connector\\Connectorfile' => $vendorDir . '/framework/Myfc/Cache/Connector/Connectorfile/Connectorfile.php',
    'Myfc\\Cache\\Connector\\Connectormemcache' => $vendorDir . '/framework/Myfc/Cache/Connector/Connectormemcache/Connectormemcache.php',
    'Myfc\\Cache\\Connector\\Connectorpredis' => $vendorDir . '/framework/Myfc/Cache/Connector/Connectorpredis/Connectorpredis.php',
    'Myfc\\Cache\\Exceptions\\extensionsExceptions\\extensionNotLoadedException' => $vendorDir . '/framework/Myfc/Cache/Exceptions/extensionsExceptions/extensionNotLoadedException/extensionNotLoadedException.php',
    'Myfc\\Cache\\Store\\File' => $vendorDir . '/framework/Myfc/Cache/Store/File.php',
    'Myfc\\Cache\\Store\\Memcache' => $vendorDir . '/framework/Myfc/Cache/Store/Memcache.php',
    'Myfc\\Cache\\Store\\Predis' => $vendorDir . '/framework/Myfc/Cache/Store/Predis.php',
    ...
    'Myfc\\Session\\Connector\\ConnectorcacheBased' => $vendorDir . '/framework/Myfc/Session/Connector/ConnectorcacheBased.php',
    'Myfc\\Session\\Connector\\ConnectorfileBased' => $vendorDir . '/framework/Myfc/Session/Connector/ConnectorfileBased.php',
    'Myfc\\Session\\Connector\\Connectorphp' => $vendorDir . '/framework/Myfc/Session/Connector/Connectorphp.php',
    'Myfc\\Session\\SessionManager' => $vendorDir . '/framework/Myfc/Session/SessionManager.php',
    'Myfc\\Session\\Starter' => $vendorDir . '/framework/Myfc/Session/Starter/Starter.php',
    'Myfc\\Session\\Store\\Cache' => $vendorDir . '/framework/Myfc/Session/store/Cache.php',
    'Myfc\\Session\\Store\\File' => $vendorDir . '/framework/Myfc/Session/store/File.php',
    'Myfc\\Session\\Store\\Php' => $vendorDir . '/framework/Myfc/Session/store/Php.php',
